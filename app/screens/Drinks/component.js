...
export default class Component extends React.Component {
  ...
  renderSuccess() {
    if (!this.state.isSuccess) {
      return (
        <View style={{ alignItems: 'center' }}>
          ...
          <Text style={[FONT_HEADLINE5_PRIMARY, styles.textBatal]}>Hapus Minuman dari menu ?</Text>
    ...
    return (
      <View style={{ alignItems: 'center' }}>
        <Text style={[FONT_HEADLINE5_PRIMARY, styles.textDelete]}>Minuman Berhasil Dihapus</Text>
  ...
  renderList() {
    return (
      <Container style={{ backgroundColor: COLOR_WHITE }}>
        <HEADER title="Minuman" back style={styles.header} />
                ...
                <Body>
                  <TouchableOpacity onPress={this._toggleBottomNavigationView}>
                    <View style={styles.icon}>
                      <Text style={styles.customers}>{I18n.t('drinks')}</Text>
                      <TouchableOpacity
          ...
          >
            <View style={styles.bottomNavigationView}>
              <View style={styles.containerBTNV}>
                <Text style={styles.detail}>Minuman</Text>
