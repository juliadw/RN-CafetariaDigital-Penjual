...
export const COLOR_BASE_PRIMARY_MAIN_CD = '#30B27C';
...
export const COLOR_FONT_PRIMARY_PASTEL = '#c4c4c4';
export const COLOR_BASE_PLACEHOLDER = '#f5f5f5';
export const COLOR_FONT_PRIMARY_MAIN = '#30B27C';

export const COLOR_FONT_SECONDARY_DARK = '#989898';
export const COLOR_FONT_SECONDARY_LIGHT = '#00E676';

export const COLOR_FONT_TERTIARY_INACTIVE = '#989898';
export const COLOR_BASE_FOOTER_CARD = '#E8E8E8';
export const COLOR_FONT_FOOTER_CARD = '#323232';

export const COLOR_EVENT_SUCCESS = '#58cd85';
export const COLOR_EVENT_BATAL = '#FB5C5C';
...
export const FONT_SIZE_SUBTITLE1 = 16;
const FONT_SIZE_SUBTITLE2 = 14;
const FONT_SIZE_BODY1 = 16;
export const FONT_SIZE_BODY2 = 15;
